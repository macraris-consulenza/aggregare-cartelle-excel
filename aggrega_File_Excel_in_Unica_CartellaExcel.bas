Attribute VB_Name = "zgare_Unisci_Fogli_Cartelle"
Sub UnisciFogliCartelle_UnicaCartella()

''''''''''''''''''''''''''''''''''''''''''''''
''''''''''''''''''''''''''''''''''''''''''''''
'' Sviluppatore: Macraris (www.vba.macraris.it)
'' DESCRIZIONE: Questa macro apre tutti i file di una cartella e esegue una
'' determinata operazione. In questo caso aggrega tutti i dati di determinati
'' fogli di diverse cartelle in una sola cartella
'' Viene fatto  uso di Cicli Do while...loop,
'' For each...Next Inoltre si fa uso di condizione If...End IF, struttura
'' With ...End With.Uso di variabili tipo Foglio nonche' cartella. Invito a
'' leggere il codice per scoprire di piu'.
...
MsgBox "Interruzione Macro Causa Errore in UnisciFogliCartelle_UnicaCartella" & vbNewLine & "Contattare Macraris" & vbNewLine & _
    vbCrLf & "Numero Errore:  # " & Err.Number & vbNewLine & _
      "Descizione Errore :==> " & Err.Description, vbCritical, "Macraris \Error Macro"
